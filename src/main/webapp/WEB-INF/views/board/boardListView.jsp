  ...
  <div id="container">
    <header class="d-flex align-items-center">
      ...
      <div class="header-area">
        <div class="title">
          <img src="../resources/images/사이트 로고.png" alt="사이트로고">
          <h1>SecondLife</h1>
        </div>
      </div>
      <div class="marginer"></div>
