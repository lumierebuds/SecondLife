	  ...
	  <div class="board-upload">
	    ...
	    <form id="board-upload-form" action="board-upload.do" method="get">
	      ...
	      <div class="imgUpload-container"> <!--이미지 관련-->
	        ...
	        <div class="imgUpload">
	          <img src="resources/image/free-icon-camera.png" alt="" width="50px">
	          <p>0/10</p>
	        </div>
	
	        <div class="additionalBox"> <!--이미지들이 추가되는 가로 공간 div-->
	      ...
	      <div class="productNameAndCategory-container"> <!-- 상품명, 카테고리 감싸는 큰 틀 div -->
	
	        <input type="text" class="productName" name="productName" placeholder="상품명" maxlength="30">
	        
	        <div class="productCategory"> <!-- ul이 들어가있는 정사각형div -->
	      ...
	      <div class="price-container">
	        <span>￦</span>
	        <input name="price" type="text" placeholder="판매가격" id="price">
	        <div class="freeSharing-box">
	          <input type="checkbox" id="freeSharing" onclick="free()">
	          <label for="freeSharing" class="custom-checkbox"></label>
	          <label for="freeSharing">무료나눔</label>
	        </div>
	      </div>
	      <section class="product-condition-container">
	        <div class="writingbox">
	          <textarea name="content" id="writing" placeholder="- 상품명(브랜드)																																																- 구매 시기																																																- 사용 기간																																																- 하자 여부																																																* 실제 촬영한 사진과 함께 상세 정보를 입력해주세요.																																																* 카카오톡 아이디 첨부 시 게시물 삭제 및 이용제재 처리될 수 있어요.																																																 																																																안전하고 건전한 거래환경을 위해 과학기술정보통신부, 한국인터넷진흥원, 세컨드라이프가 함께합니다." maxlength="1000"></textarea>
	        </div>
	        <span class="writing-length">
	          0/1000
	        </span>
	        ...
	        <div class="tradingMethod">
	          <div>
	            <input type="checkbox" name="tradeCategoryNo" value="0" id="deliveryTransaction">
	            <label for="deliveryTransaction" class="custom-checkbox"></label>
	            <label for="deliveryTransaction">택배거래</label>
	          </div>
	          <div>
	            <input type="checkbox" name="tradeCategoryNo" value="1" id="directTransaction">
	            <label for="directTransaction" class="custom-checkbox"></label>
