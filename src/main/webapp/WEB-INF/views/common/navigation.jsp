...
<body>
      ...
      <div class="nav-area">
        <div class="category">
          ...
          <c:set var="url" value="/secondlife/board/list?category="/>
          <div class="category-dropdown">
            <a href="${url }0">수입명품</a>
            <a href="${url }1">패션의류</a>
            <a href="${url }2">패션잡화</a>
            <a href="${url }3">도서/음반/문구</a>
            <a href="${url }4">출산/유아동</a>
            <a href="${url }5">모바일/태블릿</a>
            <a href="${url }6">가전제품</a>
            <a href="${url }7">노트북/PC</a>
            <a href="${url }8">가구/인테리어</a>
            <a href="${url }9">리빙/생활</a>
            <a href="${url }10">게임</a>
            <a href="${url }11">오토바이</a>
            <a href="${url }12">무료나눔</a>
          </div>
        </div>
        ...
        <div class="writer" onclick="insertBoard()">
          ...
          <span onclick="location.href='/secondlife/board/insert'">판매하기</span>
        </div>
      </div>
      <div class="marginer">
    ...
    <script>
    	// "판매하기" 버튼 누를시 거래 게시글 작성 페이지로 이동 
	  	function insertBoard() {
	  		location.href = "/secondlife/board/insert";
	  	}
    </script>
</body>
</html>